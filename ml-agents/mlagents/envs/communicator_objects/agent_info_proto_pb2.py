...
_CUSTOMOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='button_pushed', full_name='communicator_objects.CustomOutput.button_pushed', index=0,
